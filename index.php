...
$CONFIG = '{"lang":"uz","error_reporting":true,"show_hidden":true,"hide_Cols":true,"theme":"light"}';
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://ustadev.uz/" target="_blank" class="text-decoration-none text-muted">ustadev.uz</a>
                            &mdash;&mdash;
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <p class="custom-checkbox custom-control"><input type="checkbox" name="move" value="1"
                                ...
                                for="js-move-files" class="custom-control-label ms-2"> <?php echo lng('Move') ?></label>
                    </p>
                    <p>
...
if (isset($_GET['view'])) {
    ...
    <div class="row">
        <div class="col-12">
            <p class="break-word"><b><?php echo lng($view_title) ?> "<?php echo fm_enc(fm_convert_win($file)) ?>"</b>
            </p>
            <p class="break-word">
                <?php $display_path = fm_get_display_path($file_path); ?>
                <strong><?php echo $display_path['label']; ?>:</strong> <?php echo $display_path['path']; ?><br>
                <strong>File size:</strong> <?php echo ($filesize_raw <= 1000) ? "$filesize_raw bytes" : $filesize; ?>
                <br>
                ...
                if (!FM_READONLY && ($is_zip || $is_gzip) && $filenames !== false) {
                    ...
                    <form method="post" class="d-inline ms-2">
                        ...
                        <button type="submit" class="btn btn-link text-decoration-none fw-bold p-0"
                                style="font-size: 14px;"><i class="fa fa-check-circle"></i> <?php echo lng('UnZip') ?>
                        </button>
                    </form>&nbsp;
                    <form method="post" class="d-inline ms-2">
                        <input type="hidden" name="token" value="<?php echo $_SESSION['token']; ?>">
                    ...
                    <?php if (!$isNormalEditor) { ?>
                        <div class="btn-group js-ace-toolbar">
                            <button data-cmd="none" data-option="fullscreen" class="btn btn-sm btn-outline-secondary"
                                    id="js-ace-fullscreen" title="<?php echo lng('Fullscreen') ?>"><i
                                        class="fa fa-expand" title="<?php echo lng('Fullscreen') ?>"></i></button>
                            ...
                            <button data-cmd="none" data-option="wrap" class="btn btn-sm btn-outline-secondary"
                                    id="js-ace-wordWrap" title="<?php echo lng('Word Wrap') ?>"><i
                                        class="fa fa-text-width" title="<?php echo lng('Word Wrap') ?>"></i></button>
